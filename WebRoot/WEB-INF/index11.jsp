                    ...
                    <div class="panel panel-inner">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                            <div class="list-group list-group-self">
                                <a href="apply_baoxiao.jsp" target="appiframe" class="list-group-item"><span class="glyphicon glyphicon-menu-right"></span>请假申请</a>
                    ...
                    <div class="panel panel-inner">
                        ...
                        <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSeven">
                            <div class="list-group list-group-self">
                                ...
                                <a href="${pageContext.request.contextPath}/processDefinitionList"  target="appiframe" class="list-group-item"><span class="glyphicon glyphicon-menu-right"></span>查看流程</a>
                            </div>
                        </div>
                    </div>
